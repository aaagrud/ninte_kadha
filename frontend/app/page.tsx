...
export default function HomePage() {
  ...
  const handleGenerateStory = () => {
    setIsLoading(true)
    // No actual story generation, just navigate after 3 seconds
  }
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                ...
                <span className="ml-2 text-xl font-semibold text-purple-800 font-serif">Ninte കഥ</span>
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link href="#features" className="px-3 py-2 rounded-md text-sm font-medium text-purple-700 hover:text-purple-900 hover:bg-purple-100 hover:bg-opacity-50 transition-colors">
                Features
              </Link>
              <Link href="#how-it-works" className="px-3 py-2 rounded-md text-sm font-medium text-purple-700 hover:text-purple-900 hover:bg-purple-100 hover:bg-opacity-50 transition-colors">
                How It Works
              </Link>
              <Link href="#about" className="px-3 py-2 rounded-md text-sm font-medium text-purple-700 hover:text-purple-900 hover:bg-purple-100 hover:bg-opacity-50 transition-colors">
                About
              </Link>
              <Button 
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white bg-opacity-90 backdrop-blur-sm">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link href="#features" className="block px-3 py-2 rounded-md text-base font-medium text-purple-700 hover:text-purple-900 hover:bg-purple-100 hover:bg-opacity-50 transition-colors">
                Features
              </Link>
              <Link href="#how-it-works" className="block px-3 py-2 rounded-md text-base font-medium text-purple-700 hover:text-purple-900 hover:bg-purple-100 hover:bg-opacity-50 transition-colors">
                How It Works
              </Link>
              <Link href="#about" className="block px-3 py-2 rounded-md text-base font-medium text-purple-700 hover:text-purple-900 hover:bg-purple-100 hover:bg-opacity-50 transition-colors">
                About
              </Link>
              <Button 
                onClick={handleGetStarted}
